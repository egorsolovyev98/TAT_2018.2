...
namespace task_DEV8
{
    ...
    public class VehicleCatalog
    {
        ...
        public void AddToCatalog(Vehicle car)
        {
            ...
            if (isTheSameCar)
            {
                Vehicle carFromList = carsList.First(i => (i.Brand == car.Brand) && (i.Model == car.Model) && (i.Price == car.Price));
